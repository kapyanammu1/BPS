...
Public Class SoloParent
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        Try
            ...
            Else
                ...
                insert("SoloParent", "SoloParentNo,ResidentID,Cap,kag1,kag2,kag3,kag4,kag5,kag6,kag7,sec,tres,reckeeper,Purpose,ORno,ORAmount,ORDate,CTC,CTCAmount,CTCDate,PrintDate", "'" & txtNo.Text & "'," & txtResID.Text & "," &
                       ...
                       & ",'" & txtPurpose.Text & "','" & txtORno.Text & "'," & txtOrAmount.Text & ",'" & txtORDate.Text _
                       & "','" & txtCTC.Text & "'," & txtCTCAmount.Text & ",'" & txtCTCDate.Text & "','" & Date.Now.ToString("MM/dd/yyyy") & "'")
                activity("SAVED AND PRINTED A CERTIFICATE OF SOLO PARENT FOR " & txtRes.Text)
    ...
    Private Sub txtRes_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles txtRes.ButtonClick
        ...
        Search.ShowDialog()
    End Sub
    Private Sub SoloParent_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
