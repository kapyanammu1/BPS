...
Public Class BrgyClearance
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        Try
            ...
            Else
                ...
                com = New MySqlCommand("insert into brgyCLearance (clearanceNo,ResidentID,Cap,kag1,kag2,kag3,kag4,kag5,kag6,kag7,sec,tres,reckeeper,SK,Purpose,Type,ORno,ORAmount,ORDate,CTC,CTCAmount,CTCDate,PrintDate) values ('" & txtNo.Text _
                       ...
                       & "," & ds.Tables("brgyOfficials").Rows(11).Item(0) & ",'" & txtPurpose.Text & "','" & cbType.Text & "','" & txtORno.Text & "'," & txtOrAmount.Text & ",'" & txtORDate.Text & "','" & txtCTC.Text _
                       & "'," & txtCTCAmount.Text & ",'" & txtCTCDate.Text & "',@PDate)", MysqlConnect)
                com.Parameters.AddWithValue("@PDate", Date.Now)
                com.ExecuteNonQuery()

                activity("SAVED AND PRINTED A BRGY CLEARANCE FOR " & txtRes.Text)
    ...
    Private Sub txtRes_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles txtRes.ButtonClick
        ...
        Search.ShowDialog()
    End Sub
    Private Sub BrgyClearance_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
