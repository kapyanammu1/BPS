...
Public Class rptListOfBusiness
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptListOfBusiness.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListOfBusiness
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListOfBusiness = New rptListOfBusiness()
        rpt.Site = Me.Site
        Return rpt
    End Function
