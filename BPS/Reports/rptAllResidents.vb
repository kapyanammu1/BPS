...
Public Class rptAllResidents
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptAllResidents.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAllResidents
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAllResidents = New rptAllResidents()
        rpt.Site = Me.Site
        Return rpt
    End Function
