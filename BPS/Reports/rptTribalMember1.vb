...
Public Class rptTribalMember
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptTribalMember.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTribalMember
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTribalMember = New rptTribalMember()
        rpt.Site = Me.Site
        Return rpt
    End Function
