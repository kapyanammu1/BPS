...
Public Class rptCertificateList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptCertificateList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCertificateList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCertificateList = New rptCertificateList()
        rpt.Site = Me.Site
        Return rpt
    End Function
