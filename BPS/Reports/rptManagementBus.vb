...
Public Class rptManagementBus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptManagementBus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptManagementBus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptManagementBus = New rptManagementBus()
        rpt.Site = Me.Site
        Return rpt
    End Function
