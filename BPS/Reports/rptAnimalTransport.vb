...
Public Class rptAnimalTransport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptAnimalTransport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAnimalTransport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAnimalTransport = New rptAnimalTransport()
        rpt.Site = Me.Site
        Return rpt
    End Function
