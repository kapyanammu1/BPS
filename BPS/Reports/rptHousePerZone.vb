...
Public Class rptHousePerZone
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptHousePerZone.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHousePerZone
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHousePerZone = New rptHousePerZone()
        rpt.Site = Me.Site
        Return rpt
    End Function
