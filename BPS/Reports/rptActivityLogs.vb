...
Public Class rptActivityLogs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptActivityLogs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptActivityLogs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActivityLogs = New rptActivityLogs()
        rpt.Site = Me.Site
        Return rpt
    End Function
