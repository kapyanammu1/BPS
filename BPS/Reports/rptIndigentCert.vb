...
Public Class rptIndigentCert
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptIndigentCert.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIndigentCert
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIndigentCert = New rptIndigentCert()
        rpt.Site = Me.Site
        Return rpt
    End Function
