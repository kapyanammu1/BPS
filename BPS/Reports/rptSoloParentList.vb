...
Public Class rptSoloParentList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptSoloParentList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSoloParentList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSoloParentList = New rptSoloParentList()
        rpt.Site = Me.Site
        Return rpt
    End Function
