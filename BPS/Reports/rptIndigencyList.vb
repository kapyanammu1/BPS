...
Public Class rptIndigencyList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptIndigencyList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIndigencyList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIndigencyList = New rptIndigencyList()
        rpt.Site = Me.Site
        Return rpt
    End Function
