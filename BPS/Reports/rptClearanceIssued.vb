...
Public Class rptClearanceIssued
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptClearanceIssued.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClearanceIssued
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClearanceIssued = New rptClearanceIssued()
        rpt.Site = Me.Site
        Return rpt
    End Function
