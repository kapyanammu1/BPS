...
Public Class rptResidencyList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptResidencyList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResidencyList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResidencyList = New rptResidencyList()
        rpt.Site = Me.Site
        Return rpt
    End Function
