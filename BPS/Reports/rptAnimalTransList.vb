...
Public Class rptAnimalTransList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptAnimalTransList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAnimalTransList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAnimalTransList = New rptAnimalTransList()
        rpt.Site = Me.Site
        Return rpt
    End Function
