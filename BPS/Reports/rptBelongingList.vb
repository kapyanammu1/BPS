...
Public Class rptBelongingList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptBelongingList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBelongingList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBelongingList = New rptBelongingList()
        rpt.Site = Me.Site
        Return rpt
    End Function
