...
Public Class rptGoodMoralList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptGoodMoralList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGoodMoralList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGoodMoralList = New rptGoodMoralList()
        rpt.Site = Me.Site
        Return rpt
    End Function
