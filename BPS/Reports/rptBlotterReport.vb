...
Public Class rptBlotterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BPS.rptBlotterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBlotterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBlotterReport = New rptBlotterReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
